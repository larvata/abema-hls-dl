...
// const getQueryStringForTimeshiftPlaylist = (e) => {
//     // return '?' + l.default.compact(['t=' + this.token, e ? 'mq=' + e : null]).join('&')


// }

// const getTimeshiftPlaylist = () => {
//   var n = this.getQueryStringForTimeshiftPlaylist(t);
//   return p.url.slot_play + '/' + e + '/playlist.m3u8' + n + (k ? '&' + k : '')
// }
